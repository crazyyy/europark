  ...
  <div id="page-content" class="header-static footer-fixed">
    ...
    <div id="post-wrap" class="content-section fullpage-wrap">
      <div class="row margin-leftright-null">
        <div class="container">
          <div class="col-md-12 text padding-bottom-null text-center">
            <h2 class="margin-bottom-null title line center"> О местах для рыбалки</h2>
          </div>
      ...
      <div class="row margin-leftright-null">
        <div class="container">
          <div class="col-md-12 text padding-bottom-null text-center">
            <h2 class="margin-bottom-null title line center"><?php the_field('block_double_title'); ?></h2>
      ...
      <div class="row margin-leftright-null grey-background">
        <div class="container">
          ...
          <div style="clear: both;"></div>
          <p class="dopd text"> Мы рады принимать в хозяйстве EUROPARK иностранных гостей. Нам приятно освобождать Вас от забот, связанных с приездом в другую страну и создавать для Вас максимально комфортные условия. Поэтому мы с удовольствием берем на себя следующие организационные моменты:</p>
          <!-- Trek Data -->
          <div class="text padding-bottom-null trek-data text-center">
            ...
            <div class="col-sm-3 col-md-3">
              ...
              <em class="em1">Услуги переводчика</em>
            </div>
          </div>
          <!-- END Trek Data -->
